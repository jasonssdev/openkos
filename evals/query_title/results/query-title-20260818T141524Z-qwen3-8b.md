...
> **HETEROGENEOUS POPULATION — 170 filings against 476 for today's 34 probes across 14 runs.** No probe failed. Earlier generations predate probes added later, so they contribute fewer rows; per-run measures (convergence) exclude any family a generation could not populate.
