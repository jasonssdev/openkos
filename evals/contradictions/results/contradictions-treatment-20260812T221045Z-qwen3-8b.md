...
_Generated: 20260812T221045Z_ · model `qwen3:8b` · **5 runs** over 12 labelled pairs.

Labels are CONSTRUCTED, not adjudicated — see `fixtures.py`.

| metric | value |
| --- | --- |
| verdict accuracy vs label | 0.90 |
| TP retention, raw contradicts | 1.00 |
| TP retention, high-confidence | 1.00 |
| **antonym FP rate, raw contradicts** | **0.24** |
| **antonym FP rate, high-confidence** | **0.24** |
...
| concepts/personalized-recommendation <-> concepts/non-personalized-recommendation | antonym | `consistent` | `consistent` | 0.80 | 0.80 | 1.00, 1.00, 1.00, 1.00, 1.00 |
| concepts/synchronous-replication <-> concepts/asynchronous-replication | antonym | `consistent` | `consistent` | 1.00 | 1.00 | 0.95, 0.95, 1.00, 1.00, 0.95 |
...
| concepts/optimistic-locking <-> concepts/pessimistic-locking | antonym | `consistent` | `consistent` | 1.00 | 1.00 | 1.00, 1.00, 1.00, 1.00, 0.95 |
