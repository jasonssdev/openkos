# `suggest_edge_types` eval — arm `few-shot` (#508)

_Generated: 20260809T204949Z_ · model `qwen3:8b` · **5 runs** over 17 labelled edges.
...
| concepts/nightly-backup-job -> concepts/scheduled-maintenance-jobs | part_of vs member_of | `member_of` | `member_of` | 0.80 | 0.80 |
...
| concepts/eu-west-replica -> concepts/read-replicas | part_of vs member_of | `member_of` | `member_of` | 0.80 | 0.80 |
