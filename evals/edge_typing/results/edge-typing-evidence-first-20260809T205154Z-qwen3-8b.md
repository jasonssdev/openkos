# `suggest_edge_types` eval — arm `evidence-first` (#508)

_Generated: 20260809T205154Z_ · model `qwen3:8b` · **5 runs** over 17 labelled edges.
...
| concepts/report-renderer -> concepts/template-cache | depends_on vs part_of | `depends_on` | `related_to` | 0.00 | 1.00 |
