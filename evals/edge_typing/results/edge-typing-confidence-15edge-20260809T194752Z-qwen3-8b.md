# `suggest_edge_types` eval — arm `confidence-15edge` (#508)

_Generated: 20260809T194752Z_ · model `qwen3:8b` · **5 runs** over 15 labelled edges.
...
| metric | value |
| --- | --- |
| type accuracy vs label | 0.37 |
| mean stability (modal share) | 0.96 |
| degraded replies | 0 of 75 |
| mean run latency | 23.2s |
| mean stated confidence, CORRECT answers | 0.61 |
| mean stated confidence, WRONG answers | 0.55 |
...
| concepts/eu-west-replica -> concepts/read-replicas | part_of vs member_of | `member_of` | `part_of` | 0.40 | 0.60 |
