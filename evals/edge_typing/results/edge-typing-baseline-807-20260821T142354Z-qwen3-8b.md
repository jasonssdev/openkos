# `suggest_edge_types` eval — arm `baseline-807` (#508)

_Generated: 20260821T142354Z_ · model `qwen3:8b` · **15 runs** over 23 labelled edges.
...
| concepts/nightly-backup-job -> concepts/scheduled-maintenance-jobs | part_of vs member_of | `member_of` | `part_of` | 0.07 | 0.93 |
...
| concepts/eu-west-replica -> concepts/read-replicas | part_of vs member_of | `member_of` | `part_of` | 0.07 | 0.93 |
