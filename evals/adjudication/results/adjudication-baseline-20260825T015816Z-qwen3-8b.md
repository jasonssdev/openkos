...
_Generated: 20260825T015816Z_ · model `qwen3:8b` · **15 runs** over 13 labelled pairs.
...
| events/weekly-design-review <-> events/weekly-design-review-2 | recurrence | `different` | `different` | 1.00 | 1.00 | 1.00, 1.00, 1.00, 1.00, 0.95, 1.00, 0.95, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 0.95, 0.95 |
| events/sprint-retrospective <-> events/sprint-retrospective-2 | recurrence | `different` | `different` | 1.00 | 1.00 | 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 1.00, 1.00, 0.95, 0.95, 1.00, 0.95, 0.95, 0.95 |
...
| events/onboarding-working-group <-> events/onboarding-working-group-2 | asym-recurrence | `different` | `different` | 0.87 | 0.87 | 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95 |
| events/sync-arquitectura <-> events/sync-arquitectura-2 | asym-same | `same` | `same` | 1.00 | 1.00 | 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95 |
| events/vendor-selection-review <-> events/vendor-selection-review-2 | asym-same | `same` | `same` | 0.93 | 0.93 | 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95 |
...
| concepts/ingest-pipeline <-> concepts/ingest-pipeline-scheduler | part-whole | `different` | `different` | 1.00 | 1.00 | 0.95, 1.00, 1.00, 1.00, 0.95, 1.00, 0.95, 0.95, 0.95, 1.00, 1.00, 0.95, 1.00, 0.95, 1.00 |
