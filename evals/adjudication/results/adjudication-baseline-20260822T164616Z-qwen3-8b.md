...
_Generated: 20260822T164616Z_ · model `qwen3:8b` · **15 runs** over 8 labelled pairs.
...
| events/weekly-design-review <-> events/weekly-design-review-2 | recurrence | `different` | `different` | 1.00 | 1.00 | 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 0.95, 1.00, 1.00, 1.00, 1.00 |
| events/sprint-retrospective <-> events/sprint-retrospective-2 | recurrence | `different` | `different` | 1.00 | 1.00 | 1.00, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 1.00, 0.95 |
...
| concepts/model-context-protocol <-> concepts/protocolo-model-context | alias-same | `same` | `same` | 1.00 | 1.00 | 0.95, 0.95, 1.00, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95, 0.95 |
| concepts/ingest-pipeline <-> concepts/ingest-pipeline-scheduler | part-whole | `different` | `different` | 1.00 | 1.00 | 1.00, 0.95, 1.00, 0.95, 0.95, 1.00, 1.00, 1.00, 0.95, 0.95, 1.00, 1.00, 0.95, 0.95, 1.00 |
