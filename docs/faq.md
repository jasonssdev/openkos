...
OpenKOS is designed for open-weight local models via runtimes like Ollama, so you do not need API keys or a paid account. Recommended defaults are permissively licensed models such as Qwen2.5 or Mistral. You may plug in other models if you prefer.
